...
# PC2 appears to deal with war/international relations (terms include "warfare," "new world," "disarmament," etc.)
...
# "2009-Obama"   "2001-Bush"    "1997-Clinton" "1993-Clinton" "2017-Trump"  

nearest_neighbors(query = "2017-Trump", low_dim_space = inaugural_pca$x, N = 5, norm = "l2")

# "1945-Roosevelt" "1993-Clinton"   "1969-Nixon"     "1997-Clinton"   "1905-Roosevelt"