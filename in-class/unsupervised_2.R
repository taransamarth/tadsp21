...
# The best number of topics is around 15 or so topics where the Griffiths statistic begins to plateau.

#### Do you think that the number of topics is linear in the number of documents??

# Probably not? If ~15 topics is ideal for 5000 tweets and ~19 topics is ideal for 10k tweets, we're probably seeing some non-linear trend (perhaps logarithmic but I also only have two data points which isn't very helpful for making this conclusion).
